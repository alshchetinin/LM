...
<section class="action grid">
    ...
    <h2>Получить бесплатную консультацию <span><img class="img-responsive" src="<?php echo get_template_directory_uri() ?>/img/arrow_form.svg" alt=""></span></h2>
...
?>
		...
		<div class="contact-logo-abkr">
			<img src="<?php echo get_template_directory_uri() ?>/img/logo_abkr.svg" alt="" class="facebook img-responsive">
		</div>
	</div>
</footer>
<?php wp_footer(); ?>
