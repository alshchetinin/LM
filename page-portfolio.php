...
<section class="project grid">	
	...
	?>		
		...
		<?php foreach ( $terms_product_cat as $key => $product_cat ) { ?>
			...
			<div class="project_content_tab <?php if ( $key == 0 ) echo 'project_content_tab-active'; ?>" id="<?php echo $product_cat->slug; ?>" data-tab="<?php echo $product_cat->slug ; ?>">
				<?php
                ...
                <?php foreach ( $products as $post ) { setup_postdata( $post ); 
                    ...
                    <div class="project_item" style="background-image: url()">
                            ...
                            <div class="project_item_overlay">
                                ...
                                <div class="arrow"><img class="img-responsive" src="<?php echo get_template_directory_uri() ?>/img/arrow_project.svg" alt=""></div>
                            </div>
                            <a href="<?php the_permalink()?>"></a>
 							...
 							<img class="img-responsive" src="<?php the_field('img_desktop'); ?>" alt="<?php the_title(); ?> | <?php the_field('slider_text'); ?>">
							</picture>
                    </div>
